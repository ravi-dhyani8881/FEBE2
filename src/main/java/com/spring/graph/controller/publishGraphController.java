...
public class publishGraphController {
    ...
    public publishGraphResponseTemplate findpublishGraphByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
		...
		return  genericQueryResolver.findpublishGraphByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, field);	
			...
			@SchemaMapping
			public userResponseTemplate finduserByQuery(RecordspublishGraph content, @Argument String query, @Argument String start,@Argument String rows,
		...
		return genericQueryResolver.findorganizationByQuery(query2, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, field);
			...
			@SchemaMapping
			public environmentResponseTemplate findenvironmentByQuery(RecordspublishGraph content, @Argument String query, @Argument String start,@Argument String rows,
    												@Argument String filterField, @Argument String filterQuery,
    							  @Argument String sort,@Argument String advanceField,@Argument String advanceQuery,@Argument String advance,@Argument String field) throws Exception {
		String query2=QueryUtils.replaceTokens(query, content);	
